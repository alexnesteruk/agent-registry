...
argument-hint: "[optional: specific thing to check on, e.g. \"cheat sheet\" or \"Nacua suspension\"]"
---
...
6. If `$ARGUMENTS` is non-empty, treat it as a focus request — answer that specifically after the briefing; otherwise give the full standard briefing below.
